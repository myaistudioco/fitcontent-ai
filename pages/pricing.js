      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 20px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <h1 style={{
            ...
            background: "linear-gradient(135deg, #fff 0%, #FF6B00 100%)",
            WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"
          }}>START FREE. GROW FAST.</h1>

          <p style={{ color: "#666", fontSize: 16, maxWidth: 480, margin: "0 auto", lineHeight: 1.6 }}>
            No credit card required to start. Upgrade when you're ready to post more.
          </p>
        </div>
        ...
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap", marginBottom: 60 }}>
          ...
          <div className="plan-card">
            ...
            <button className="cta-btn secondary" onClick={() => window.location.href = "/"}>
              Get Started Free
            </button>
          </div>
        ...
        <div style={{
          ...
          <h2 style={{
            fontFamily: "'Bebas Neue', sans-serif",
            fontSize: 32, letterSpacing: 2, marginBottom: 32, textAlign: "center"
          }}>FREQUENTLY ASKED QUESTIONS</h2>

          {[
            { q: "Do I need a credit card to start?", a: "No! Start completely free. No credit card needed." },
        ...
        <div style={{ textAlign: "center", marginTop: 60 }}>
          <p style={{ color: "#555", fontSize: 14, marginBottom: 20 }}>
            Join fitness coaches saving 10+ hours every week
          </p>
          <a href="/" style={{
            background: "linear-gradient(135deg, #FF6B00, #FF3D00)",
